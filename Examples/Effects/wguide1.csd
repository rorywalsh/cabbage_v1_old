...
image           bounds(0, 0, 415,125), colour(125, 95, 55), shape("sharp"), outlinecolour(225,195,155), outlinethickness(2) 
label   bounds(227,  4,180, 22), text("W A V E G U I D E"), fontcolour(silver)
image   bounds(229,  8,175,  1), colour(200,170,130), shape("sharp"), outlinecolour(silver), outlinethickness(1)
image   bounds(232, 22,172,  1), colour(200,170,130), shape("sharp"), outlinecolour(silver), outlinethickness(1)
...
rslider  bounds( 10, 41, 70, 70),  text("Frequency"),  channel("freq"),      trackercolour(225,195,155), range(8.2, 12542, 160, 0.25),  colour( 85, 55,15), textcolour(white)
rslider  bounds( 75, 41, 70, 70),  text("Note Num."),  channel("notnum"),    trackercolour(225,195,155), range(0, 127, 51, 1,1),        colour( 85, 55,15), textcolour(white)
rslider  bounds(140, 41, 70, 70),  text("Cutoff"),     channel("cutoff"),    trackercolour(225,195,155), range(20,20000,8000,0.25),     colour( 85, 55,15), textcolour(white)
rslider  bounds(205, 41, 70, 70),  text("Feedback"),   channel("feedback"),  trackercolour(225,195,155), range(-0.99999, 0.99999, 0.8), colour( 85, 55,15), textcolour(white)
rslider  bounds(270, 41, 70, 70),  text("Mix"),        channel("mix"),       trackercolour(225,195,155), range(0, 1.00, 1),             colour( 85, 55,15), textcolour(white)
rslider  bounds(335, 41, 70, 70),  text("Level"),      channel("level"),     trackercolour(225,195,155), range(0, 1.00, 0.7),           colour( 85, 55,15), textcolour(white)
