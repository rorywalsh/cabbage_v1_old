<Cabbage>
form caption("Gaussian Dust"), size(325, 80), pluginID("gaus")
image bounds(  0,  0,325, 80), colour("DarkSlateGrey"), shape("rounded"), outline("white"), line(4) 
checkbox bounds( 15, 10, 80, 15), text("On/Off"), channel("onoff"), value(1), fontcolour("white")
combobox bounds( 10, 40, 70, 20), channel("mode"), value(1), text("Held", "Reinit")
