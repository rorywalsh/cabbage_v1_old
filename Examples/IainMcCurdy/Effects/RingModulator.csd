<Cabbage>
form caption("Ring Modulator") size(435, 120)
image pos(0, 0), size(435, 90), colour("black"), shape("rounded"), outline("lime"), line(5) 
rslider bounds(  5, 11, 70, 70), text("Freq."), channel("freq"), range(0, 15000, 800, 0.25), colour("yellow")
rslider bounds( 75, 11, 70, 70), text("Sine/Sq."), channel("wave"), range(0, 1, 0), colour("yellow")
line    bounds(150, 2, 3, 86), colour("lime")
rslider bounds(160, 11, 70, 70), text("Env."), channel("env"), range(0, 1, 0.5, 0.5), colour("orange")
...
rslider bounds(290, 11, 70, 70), text("Mix"), channel("mix"), range(0, 1, 1), colour("chocolate")
rslider bounds(360, 11, 70, 70), text("Level"), channel("level"), range(0, 1, 1), colour("chocolate")
</Cabbage>
<CsoundSynthesizer>
<CsOptions>
-d -n
