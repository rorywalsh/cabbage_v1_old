...
image pos(0, 0), size(530, 200), colour(255,255,150), shape("rounded"), outlinecolour("LightBrown"), line(4)
...
label    bounds( 12, 10, 75, 11), text("Carrier Source"), FontColour("black")
...
label    bounds( 20, 70, 60, 11), text("Synth Type"), FontColour("black")
...
rslider bounds(445, 38, 70, 70), text("Level"), colour(255,255,120), FontColour("Black"), channel("level"), range(0, 5.00, 1,0.5)
