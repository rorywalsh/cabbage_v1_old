<Cabbage>
form caption("PVS Rec/Play") size(610, 250), pluginID("pvrp")

groupbox bounds(0, 2, 300, 95), text("Transport")

label    bounds(10, 78, 70, 14), text("Record") 
label    bounds(80, 78, 70, 14), text("Pause") 
label    bounds(150, 78, 70, 14), text("Play Loop") 
label    bounds(220, 78, 70, 14), text("Play Once") 
checkbox bounds(10, 28, 70, 50), channel("Record"), value(0), shape("square"), colour("red")
checkbox bounds(80, 28, 70, 50), channel("Pause"), value(0), shape("square"), colour("Blue")
checkbox bounds(150, 28, 70, 50), channel("PlayLoop"), value(0), shape("square")
checkbox bounds(220, 28, 70, 50), channel("PlayOnce"), value(0), shape("square"), colour("yellow")

hslider bounds(302, 0, 300, 50), channel("Speed"), range(-4.00, 4.00, 1)	;, text("Speed")
label   bounds(402, 40, 100, 13), text("Speed") , align(centre)
hslider bounds(302, 48, 300, 50), channel("Pitch"), range(0.25, 4.00, 1)	;, text("Pitch")
label   bounds(402, 88, 100, 13), text("Pitch") , align(centre) 
hslider bounds(2, 100, 300, 50), channel("LoopBeg"), range(0, 1, 0)	;, text("Loop Begin")
label   bounds(102, 140, 100, 13), text("Loop Begin")  , align(centre)
hslider bounds(2, 150, 300, 50), channel("LoopEnd"), range(0, 1, 1)	;, text("Loop End")
label   bounds(102, 190, 100, 13), text("Loop End")  , align(centre)
hslider bounds(302, 100, 300, 50), channel("InGain"), range(0, 1, 1)	;, text("Input Gain")
label   bounds(402, 140, 100, 13), text("Input Gain")  , align(centre)
hslider bounds(302, 150, 300, 50), channel("OutGain"), range(0, 1, 1)	;, text("Output Gain")
label   bounds(402, 190, 100, 13), text("Output Gain")  , align(centre)
