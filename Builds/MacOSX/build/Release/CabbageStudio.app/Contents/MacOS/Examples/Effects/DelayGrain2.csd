...
hslider  bounds(  5, 50, 400, 25), channel("Dens"), range(0.2, 100, 5,0.5,0.001)
...
if changed(kwindow)==1 || trigger:k(kTimer,1,0)==1 then
 reinit UPDATE
endif
UPDATE:
iGSize	=	i(kGSize)
aEnv	poscil	1,1/iGSize,giwfn1+i(kwindow)-1
kTimer	line	0,1/iGSize,1
rireturn
