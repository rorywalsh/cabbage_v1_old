...
image bounds(150, 0, 700, 500), file("/sdcard/cabbage.png"), identchannel("cabbage")
image bounds(150, 0, 700, 500), file("/sdcard/cabbageEarphones.png"), identchannel("phones") 
label bounds(0, 480, 1024, 30), text("Press the Options button to begin..."), align("centre"), fontcolour("white"), identchannel("text")
</Cabbage>
<CsoundSynthesizer>
<CsOptions>
-m0d
