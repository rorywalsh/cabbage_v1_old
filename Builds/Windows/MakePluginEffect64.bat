...
set OUTPUT_TARGET=CabbagePluginEffect.dat

IF "%1"=="release" set COMPILER_FLAGS= -Wall -Wreorder -Wno-strict-aliasing -O0 -static-libgcc -static-libstdc++ -Wno-strict-overflow -march=x86-64 -O -std=gnu++0x -mstackrealign
