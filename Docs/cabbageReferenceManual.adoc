...
[source]
----
image bounds(x, y, width, height), colour("colour"), file("file name"), shape("type"), outline("colour"), line(thickness), `plant("name"), identchannel("channel"), visible(val), alpha(val), rotate(radians, pivotx, pivoty), widgetarray("chan", number)
----
...
[[vslider]][[vslider2]][[vslider3]][[hslider]][[hslider2]][[hslider3]][[rslider]]
=== Sliders
[source]
----
