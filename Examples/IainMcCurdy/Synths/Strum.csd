...
; box 1
image    bounds(  0,  0,320,300), colour(250,230,255),    shape("rounded"), oulinecolour("white"), line(0)
xypad    bounds(  0,  0,320,300), colour(220,200,250), channel("x", "y"), rangex(0, 1.00, 0), rangey(0, 1, 0)

image    bounds(  0,300,320,100), colour(220,200,250),    shape("rounded"), oulinecolour("white"), line(0)
rslider  bounds(  0,305, 70, 70), channel("notes"),     text("Notes"),    textBox(1), range(1, 50, 5,1,1),      colour("SlateGrey"), trackercolour("white"), fontcolour("DarkSlateGrey")
rslider  bounds( 50,305, 70, 70), channel("spacing"),   text("Spacing"),  textBox(1), range(0.25, 6.00, 1,1,0.25), colour("SlateGrey"), trackercolour("white"), fontcolour("DarkSlateGrey")
rslider  bounds(100,305, 70, 70), channel("offset"),    text("Offset"),   textBox(1), range(24, 72, 48,1,1),       colour("SlateGrey"), trackercolour("white"), fontcolour("DarkSlateGrey")
rslider  bounds(150,305, 70, 70), channel("shift"),     text("Shift"),    textBox(1), range(-24, 24, 12,1,0.25),      colour("SlateGrey"), trackercolour("white"), fontcolour("DarkSlateGrey")
rslider  bounds(200,305, 70, 70), channel("PolyLimit"), text("Polyphony"),textBox(1), range(1, 24, 3,1,1),         colour("SlateGrey"), trackercolour("white"), fontcolour("DarkSlateGrey")
rslider  bounds(250,305, 70, 70), channel("lev"),       text("Level"),    textBox(1), range(0, 1.00, 0.3),         colour("SlateGrey"), trackercolour("white"), fontcolour("DarkSlateGrey")
