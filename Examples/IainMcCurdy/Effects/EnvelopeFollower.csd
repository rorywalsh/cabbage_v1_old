<Cabbage>
form caption("Envelope Follower") size(440, 130)
image pos(0, 0), size(440, 100), colour("brown"), shape("rounded"), outline("white"), line(4)
checkbox bounds(15, 70, 15, 15), channel("lev1"), value(0), colour(100,120,0),shape("ellipse")
checkbox bounds(15, 55, 15, 15), channel("lev2"), value(0), colour(150, 90,0),shape("ellipse")
checkbox bounds(15, 40, 15, 15), channel("lev3"), value(0), colour(200, 60,0),shape("ellipse")
checkbox bounds(15, 25, 15, 15), channel("lev4"), value(0), colour(250, 30,0),shape("ellipse")
checkbox bounds(15, 10, 15, 15), channel("lev5"), value(0), colour(255,  0,0),shape("ellipse")
rslider bounds( 40, 11, 75, 75), text("Sensitivity"), channel("sens"), range(0, 1, 0.65)
rslider bounds(110,  6, 45, 45), text("Att."), channel("att"), range(0.001, 0.5, 0.01, 0.5, 0.001)
rslider bounds(110, 51, 45, 45), text("Dec."), channel("rel"), range(0.001, 0.5, 0.2, 0.5, 0.001)
rslider bounds(150, 11, 75, 75), text("Frequency"), channel("freq"), range(10, 10000, 1000, 0.5)
rslider bounds(220, 11, 75, 75), text("Resonance"), channel("res"), range(0,  1, 0.75)
rslider bounds(290, 11, 75, 75), text("Distortion"), channel("dist"), range(0,  1, 0)
rslider bounds(360, 11, 75, 75), text("Level"), channel("level"), range(0, 1, 1)
}
</Cabbage>
<CsoundSynthesizer>
<CsOptions>
