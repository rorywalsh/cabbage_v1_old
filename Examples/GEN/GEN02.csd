...
rslider bounds( 55,  0, 50, 50), channel("note2"), text("Note.2"), range(0, 108, 50, 1, 1),colour("yellow"),trackercolour("yellow")
rslider bounds(105,  0, 50, 50), channel("note3"), text("Note.3"), range(0, 108, 46, 1, 1),colour("yellow"),trackercolour("yellow")
rslider bounds(155,  0, 50, 50), channel("note4"), text("Note.4"), range(0, 108, 48, 1, 1),colour("yellow"),trackercolour("yellow")
rslider bounds(205,  0, 50, 50), channel("note5"), text("Note.5"), range(0, 108, 54, 1, 1),colour("yellow"),trackercolour("yellow")
rslider bounds(255,  0, 50, 50), channel("note6"), text("Note.6"), range(0, 108, 53, 1, 1),colour("yellow"),trackercolour("yellow")
rslider bounds(305,  0, 50, 50), channel("note7"), text("Note.7"), range(0, 108, 51, 1, 1),colour("yellow"),trackercolour("yellow")
rslider bounds(355,  0, 50, 50), channel("note8"), text("Note.8"), range(0, 108, 42, 1, 1),colour("yellow"),trackercolour("yellow")
rslider bounds(  5, 60, 50, 50), channel("amp1"), text("Vel.1"), range(0, 1.00, 0.8 ),colour("green"),trackercolour("lime")
rslider bounds( 55, 60, 50, 50), channel("amp2"), text("Vel.2"), range(0, 1.00, 0.37),colour("green"),trackercolour("lime")
rslider bounds(105, 60, 50, 50), channel("amp3"), text("Vel.3"), range(0, 1.00, 0.4 ),colour("green"),trackercolour("lime")
rslider bounds(155, 60, 50, 50), channel("amp4"), text("Vel.4"), range(0, 1.00, 0.7 ),colour("green"),trackercolour("lime")
rslider bounds(205, 60, 50, 50), channel("amp5"), text("Vel.5"), range(0, 1.00, 0.4 ),colour("green"),trackercolour("lime")
rslider bounds(255, 60, 50, 50), channel("amp6"), text("Vel.6"), range(0, 1.00, 0.8 ),colour("green"),trackercolour("lime")
rslider bounds(305, 60, 50, 50), channel("amp7"), text("Vel.7"), range(0, 1.00, 0.45),colour("green"),trackercolour("lime")
rslider bounds(355, 60, 50, 50), channel("amp8"), text("Vel.8"), range(0, 1.00, 0.5 ),colour("green"),trackercolour("lime")
rslider bounds(  5,120, 50, 50), channel("speed1"), text("Speed.1"), range(1, 4, 2,1,1),colour("blue"),trackercolour("lightblue")
rslider bounds( 55,120, 50, 50), channel("speed2"), text("Speed.2"), range(1, 4, 2,1,1),colour("blue"),trackercolour("lightblue")
rslider bounds(105,120, 50, 50), channel("speed3"), text("Speed.3"), range(1, 4, 2,1,1),colour("blue"),trackercolour("lightblue")
rslider bounds(155,120, 50, 50), channel("speed4"), text("Speed.4"), range(1, 4, 1,1,1),colour("blue"),trackercolour("lightblue")
rslider bounds(205,120, 50, 50), channel("speed5"), text("Speed.5"), range(1, 4, 1,1,1),colour("blue"),trackercolour("lightblue")
rslider bounds(255,120, 50, 50), channel("speed6"), text("Speed.6"), range(1, 4, 2,1,1),colour("blue"),trackercolour("lightblue")
rslider bounds(305,120, 50, 50), channel("speed7"), text("Speed.7"), range(1, 4, 1,1,1),colour("blue"),trackercolour("lightblue")
rslider bounds(355,120, 50, 50), channel("speed8"), text("Speed.8"), range(1, 4, 1,1,1),colour("blue"),trackercolour("lightblue")
rslider bounds( 15,180, 50, 50), channel("fshift"), text("Harm."), range(0, 32, 0,1,1),   colour("red")
rslider bounds( 70,180, 50, 50), channel("filt"),   text("Filt."), range(-4.00, 4.00, 0), colour("red")
rslider bounds(125,180, 50, 50), channel("res"),    text("Res."),  range(0, 0.99, 0.7),   colour("red")
rslider bounds(180,180, 50, 50), channel("dur"),    text("Dur."),  range(0.10, 4, 1,0.5), colour("red")
rslider bounds(235,180, 50, 50), channel("echo"),   text("Echo"),  range(0, 1.00, 0.3),   colour("pink")
rslider bounds(290,180, 50, 50), channel("rpts"),   text("Repeats")range(0, 1.00, 0.4),   colour("pink")
rslider bounds(345,180, 50, 50), channel("time"),   text("Time"),  range(0, 7, 3,1,1),    colour("pink")
rslider bounds(345,240, 60, 60), channel("amp"),    text("Level"), range(0, 1.00, 0.6),   colour("orange")
vslider bounds( 25,222,50,  80), text(""), channel("dir"), fontcolour("black"), range(0, 3, 2,1,1), colour("white"), trackercolour("black")
label    bounds( 38,237, 55, 11), text("Bwd"),  FontColour("white")
label    bounds( 52,254, 55, 11), text("Fwd/Bwd"),  FontColour("white")
label    bounds( 38,270, 55, 11), text("Fwd"),  FontColour("white")
label    bounds( 39,287, 55, 11), text("Stop"),  FontColour("white")
hslider  bounds(105,235,250, 35), channel("tempo"),range(10,500,150, 1, 1), colour("white"), trackercolour("black")
label    bounds(206,262, 50, 14), text("Tempo"),  FontColour("white")
}
</Cabbage>                                                   
...
instr	4
	...
	atap	deltapi	adeltim					; tap delay buffer
		delayw	(a1*kecho)+(atap*krpts*0.001)			; write audio into delay buffer. Add in a bit of feedback
