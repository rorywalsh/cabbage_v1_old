...
<Cabbage>
form caption("Image Sliders"), scrollbars(0), size(1024, 520), pluginID("ExSl"),colour(0,0,0), guirefresh(64)
image bounds(0,0,0,0), widgetarray("slider",20)
label      bounds(670,255,250, 20), text("Click and drag anywhere..."), fontcolour("white"), visible(1), identchannel("instruction")
...
;          x   y  r   g   b   n
$SLIDER_UP(210 '10'250' 50' 50'1)
$SLIDER_UP(270 '10' 50'250' 50'2)
$SLIDER_UP(330'10' 50' 50'250'3)
$SLIDER_UP(390'10'255'  0'  0'4)
$SLIDER_UP(450'10'255'255' 50'5)
$SLIDER_UP(510'10' 50'150'100'6)
$SLIDER_UP(570'10' 50' 50'250'7)
$SLIDER_UP(630'10'150'  0' 50'8)
$SLIDER_UP(690'10'204'102'  0'9)
$SLIDER_UP(750'10'100'200' 30'10)
...
; Expand the macro for each slider with relevant substitution values
;            x    y   r   g   b   n
$SLIDER_DOWN(210'270'255'255'  0'11)
$SLIDER_DOWN(270'270'255'  0'127'12)
$SLIDER_DOWN(330'270'128'255'  0'13)
$SLIDER_DOWN(390'270'128'128'128'14)
$SLIDER_DOWN(450'270'204'102'  0'15)
$SLIDER_DOWN(510'270'153'  0' 76'16)
$SLIDER_DOWN(570'270'  0'255'  0'17)
$SLIDER_DOWN(630'270'255'153'153'18)
$SLIDER_DOWN(690'270'178'102'255'19)
$SLIDER_DOWN(750'270'255'255'255'20)
...
instr	99 ; melt instruction after the first click
 ...
 Sfade	sprintfk	"fontcolour(255,255,255,%d), bounds(370,%d,250, 20)",kalpha,ky
