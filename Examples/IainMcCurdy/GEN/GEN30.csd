...
table bounds(  5,  5, 400, 120), identchannel("table1"), tableNumbers(1,2), tablecolour("lime","yellow")
...
button   bounds(250,152, 80, 18), text("SOURCE","RESULT"), channel("ListenTo"), value(1), fontcolour("silver")
...
hslider  bounds(  5,220,400, 30), channel("frq"), text("Frequency"), textBox(1), range(1, 5000, 200,0.5), TrackerColour("yellow")
hslider  bounds(  5,250,400, 30), channel("amp"), text("Amplitude"), textBox(1), range(0,    1, 0.1), TrackerColour("yellow")
</Cabbage>
