...
image    bounds(  0,  0,810, 90), colour("black"), shape("rounded"), outlinecolour(255,100,0), outlinethickness(2) 
button   bounds( 10, 20, 80, 50), text("Live","Noise"), channel("input"), value(0)
