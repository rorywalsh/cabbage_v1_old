...
<Cabbage>
form caption("waveset") size(510, 120)
...
rslider bounds(290, 10, 70, 70), text("Threshold"), channel("thresh"), range(0, 1, 1), colour("orange"), fontcolour("white")
rslider bounds(355, 10, 70, 70), text("Metro Rate"), channel("rate"), range(0, 5, 0), colour("orange"), fontcolour("white")
line bounds(430, 2, 3, 86), colour("Grey")
rslider bounds(435,  10, 70, 70), text("Level"), channel("level"), range(0, 1, 0.7), colour("LightBlue"), fontcolour("white")
}
</Cabbage>
