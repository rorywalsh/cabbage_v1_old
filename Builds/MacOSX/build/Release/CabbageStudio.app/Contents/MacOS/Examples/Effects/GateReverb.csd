...
rslider bounds( 90,  5, 75, 75), channel("FiltMin"),    text("Min."),      range(4,14,4), textbox(1), $RSliderStyle
rslider bounds(150,  5, 75, 75), channel("FiltMax"),    text("Max."),      range(4,14,14), textbox(1), $RSliderStyle
...
instr	1
 ...
 if changed(kInOutMode,kTotNum,kTotDel,kScatAmp,kShape,kScatTim,kDelayDry)==1 then		; FORCE A REINITIALISATION IF ANY OF THE LISTED K-VARIABLES CHANGE
  		reinit	RESTART
 endif
 RESTART:
