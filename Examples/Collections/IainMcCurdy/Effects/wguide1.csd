...
image   bounds(229,  8,175,  1), colour(200,170,130), shape("sharp"), outlinecolour(silver), line(1)
image   bounds(232, 22,172,  1), colour(200,170,130), shape("sharp"), outlinecolour(silver), line(1)
