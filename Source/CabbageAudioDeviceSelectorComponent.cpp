...
//==============================================================================
class CabbageAudioDeviceSelectorComponent::MidiInputSelectorComponentListBox  : public ListBox,
...
public:
                           ...
                           bool rowIsSelected)
    {
        ...
        if (isPositiveAndBelow (row, items.size()))
        {
            ...
            g.setColour (Colours::whitesmoke.withMultipliedAlpha (enabled ? 1.0f : 0.6f));
...
private:
    ...
    void updateInputsComboBox()
    {
        if (setup.maxNumInputChannels > 0 && type.hasSeparateInputsAndOutputs())
        {
            if (inputDeviceDropDown == nullptr)
            {
                ...
                inputDeviceDropDown->setColour(ComboBox::textColourId, Colour(200, 200, 200));
    ...
    void updateSampleRateComboBox (AudioIODevice* currentDevice)
    {
        if (sampleRateDropDown == nullptr)
        {
            ...
            sampleRateDropDown->setColour(ComboBox::textColourId, Colour(200, 200, 200));
    ...
    void updateBufferSizeComboBox (AudioIODevice* currentDevice)
    {
        if (bufferSizeDropDown == nullptr)
        {
            ...
            bufferSizeDropDown->setColour(ComboBox::textColourId, Colour(200, 200, 200));
...
//==============================================================================
CabbageAudioDeviceSelectorComponent::CabbageAudioDeviceSelectorComponent (AudioDeviceManager& dm,
      ...
      hideAdvancedOptionsWithButton (hideAdvancedOptionsWithButton_)
{
    ...
    if (types.size() > 1)
    {
        ...
        deviceTypeDropDown->setColour(ComboBox::textColourId,  Colour(200, 200, 200));
    ...
    if (showMidiInputOptions)
    {
        ...
        midiInputsList->setColour(ComboBox::textColourId,  Colour(200, 200, 200));
    ...
    if (showMidiOutputSelector)
    {
        ...
        midiOutputSelector->setColour(ComboBox::textColourId,  Colour(200, 200, 200));
...
void CabbageAudioDeviceSelectorComponent::childBoundsChanged (Component* child)
{
    if (child == audioDeviceSettingsComp)
        resized();
}

void CabbageAudioDeviceSelectorComponent::comboBoxChanged (ComboBox* comboBoxThatHasChanged)
{
...
void CabbageAudioDeviceSelectorComponent::changeListenerCallback (ChangeBroadcaster*)
{
    updateAllControls();
}

void CabbageAudioDeviceSelectorComponent::updateAllControls()
{
    if (deviceTypeDropDown != nullptr)
