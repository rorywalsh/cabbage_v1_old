...
image pos(0, 0), size(315, 90), colour("Brown"), shape("rounded"), outline("white"), line(4) 
rslider bounds(10, 11, 70, 70), text("Width"), channel("width"), range(0, 1, 0)
rslider bounds(75, 11, 70, 70), text("Centre"), channel("center"), range(-1, 1, 0)
combobox bounds(150, 20, 80,25), channel("bipolar"), size(80,50), value(2), text("Unipolar", "Bipolar")
rslider bounds(235, 11, 70, 70), text("Level"), channel("level"), range(0, 1, 0.7)
}
</Cabbage>
