<Cabbage>
form caption("Time-domain Freq-shift") size(380, 130)
image bounds(10, 10, 360, 90), colour("darkslategrey"), outline("white")
rslider bounds(15, 20, 70, 70), text("Mix"), channel("mix"), range(0, 1, 0.5)
rslider bounds(85, 20, 70, 70), text("Freq."), channel("freq"), range(-1000, 1000, -50)
rslider bounds(155, 20, 70, 70), text("Mult"), channel("mult"), range(-1, 1, 0.1)
rslider bounds(225, 20, 70, 70), text("Feedback"), channel("fback"), range(0, .75, .6)
rslider bounds(295, 20, 70, 70), text("Level"), channel("level"), range(0, 1, 1)
