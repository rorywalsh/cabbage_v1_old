...
rslider bounds(10, 11, 70, 70), text("Frequency"), fontcolour("black"), channel("freq"), tracker("black"), range(20, 8000, 160, 0.25), colour("yellow")
rslider bounds(75, 11, 70, 70), text("Cutoff"), fontcolour("black"),channel("cutoff"), tracker("black"), range(20,20000,8000,0.25), colour("yellow")
rslider bounds(140, 11, 70, 70), text("Feedback"), fontcolour("black"),channel("feedback"), tracker("black"), range(-0.999, 0.999, 0.8), colour("yellow")
rslider bounds(205, 11, 70, 70), text("Mix"), fontcolour("black"), channel("mix"), tracker("black"), range(0, 1, 0.7), colour("yellow")
rslider bounds(270, 11, 70, 70), text("Level"), fontcolour("black"), channel("level"), tracker("black"), range(0, 1, 0.7), colour("yellow")
}
</Cabbage>
