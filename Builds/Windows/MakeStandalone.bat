...
set PREPROCESSOR_DEFS=-D__MINGW__=1 -D__MINGW_EXTENSION= -DCabbage_Build_Standalone=1 -DUSE_DOUBLE=1 -DCSOUND6 -DCabbage_GUI_Editor=1 -DJUCER_CODEBLOCKS_20734A5D=1
...
set CABBAGE_SOURCE_DIR=%CABBAGE_SOURCE_DIR%
