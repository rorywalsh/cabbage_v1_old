...
CALL mingw32-make -f MakefileStandalone64.mak -j4 CONFIG=Release
CALL mingw32-make -f MakefilePluginEffect64.mak CONFIG=Release clean
CALL mingw32-make -f MakefilePluginEffect64.mak -j4 CONFIG=Release
CALL mingw32-make -f MakefilePluginSynth64.mak CONFIG=Release clean
CALL mingw32-make -f MakefilePluginSynth64.mak -j4 CONFIG=Release
