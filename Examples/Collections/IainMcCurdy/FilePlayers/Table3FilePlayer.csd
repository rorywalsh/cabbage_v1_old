...
<Cabbage>
form caption("Table3 File Player") size(685,340), colour(0,0,0) pluginID("T3Pl"), guirefresh(64)
image                    bounds(  0,  0,685,340), colour(30, 30, 70), outlinecolour("White"), line(3), shape("sharp")	; main panel colouration    
...
instr	1	; Read in widgets
 ...
 if changed(gkLoopStart,gkLoopLen)==1 then
  gkEditMode	=	1	; C.A.D
 elseif  changed(gkLoopStart2,gkLoopEnd2)==1 then
