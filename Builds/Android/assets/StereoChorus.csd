...
<Cabbage>
form caption("Stereo Chorus") size(595, 100), pluginID("scho"), androidinfo("Reverse. Written by Iain McCurdy, 2012")
image                 bounds(0, 0, 595, 100), colour("DarkSlateGrey"), shape("rounded"), outlinecolour("white"), outlinethickness(6), identchannel("mainPlant"), plant("fullgui") {
