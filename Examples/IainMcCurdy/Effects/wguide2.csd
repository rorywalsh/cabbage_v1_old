...
rslider bounds(400, 11, 70, 70), text("Mix"), channel("mix"), range(0, 1, 0.7),colour(150,110,110)
rslider bounds(465, 11, 70, 70), text("Level"), channel("level"), range(0, 1, 0.7),colour(150,110,110)
}
</Cabbage>
