...
image pos(0, 0), size(370, 90), colour("black"), shape("rounded"), outline("white"), line(4) 
rslider bounds(10, 11, 70, 70), text("Scale"), channel("scal"), range(0.1, 10, 1, 0.5, 0.0001)
rslider bounds(80, 11, 70, 70), text("Shift"), channel("shift"), range(0, 5000, 1, 0.5)
rslider bounds(150, 11, 70, 70), text("Feedback"), channel("FB"), range(0, 1, 0)
rslider bounds(220, 11, 70, 70), text("Mix"), channel("mix"), range(0, 1, 1)
rslider bounds(290, 11, 70, 70), text("Level"), channel("lev"), range(0, 1, 0.5)
</Cabbage>
