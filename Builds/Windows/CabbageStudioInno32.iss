...
[Setup]
OutputBaseFilename=CabbageStudio32Setup
AppName=CabbageStudio
AppVersion=v0.5.13
DefaultDirName={pf}\CabbageStudio32
DefaultGroupName=CabbageStudio32
UninstallDisplayIcon={app}\CabbageStudio.exe
...
Source: "build\CabbageStudio.exe";                                  DestDir: "{app}"; Components: program
...
Source: "build\AutomationTrack.csd";                                  DestDir: "{app}"; Components: program
...
[Icons]
Name: "{group}\CabbageStudio32"; Filename: "{app}\CabbageStudio.exe"
