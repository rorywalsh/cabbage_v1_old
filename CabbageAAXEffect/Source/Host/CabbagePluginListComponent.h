...
#ifndef CabbagePluginListComponent_H_INCLUDED
#define CabbagePluginListComponent_H_INCLUDED
...
public:
    ...
    */
    ...
    /** Destructor. */
    ~CabbagePluginListComponent();

    /** Changes the text in the panel's options button. */
    void setOptionsButtonText (const String& newText);

    /** Sets how many threads to simultaneously scan for plugins.
        If this is 0, then all scanning happens on the message threapathChooserWindowd (this is the default)
    */
...
#endif   // JUCE_CabbagePluginListComponent_H_INCLUDED
