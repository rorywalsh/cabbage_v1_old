...
;image bounds(-60,-10,630,110), colour(150,255,100,200), outlinecolour("silver"), line(6), shape("ellipse")
rslider bounds( 10, 10, 70, 70), text("Coarse"),     channel("coarse"),    range(-4000, 4000, 0, 1),    colour("orange"), trackercolour("yellow"), fontcolour("white"), ;fontcolour("black")
rslider bounds( 80, 10, 70, 70), text("Multiplier"), channel("fine"),      range(-1, 1, 1, 1, 0.0001),  colour("orange"), trackercolour("yellow"), fontcolour("white"), ;fontcolour("black")
rslider bounds(150, 10, 70, 70), text("Lowest"),     channel("lowest"),    range( 20, 20000, 20, 0.5),  colour("orange"), trackercolour("yellow"), fontcolour("white"), ;fontcolour("black")
rslider bounds(220, 10, 70, 70), text("Feedback"),   channel("FB"),        range(0, 1.00, 0),           colour("orange"), trackercolour("yellow"), fontcolour("white"), ;fontcolour("black")
rslider bounds(290, 10, 70, 70), text("FFT Size"),   channel("att_table"), range(1, 8, 5, 1,1),         colour("orange"), trackercolour("yellow"), fontcolour("white"), ;fontcolour("black")
rslider bounds(360, 10, 70, 70), text("Mix"),        channel("mix"),       range(0, 1.00, 1),           colour("orange"), trackercolour("yellow"), fontcolour("white"), ;fontcolour("black")
rslider bounds(430, 10, 70, 70), text("Level"),      channel("lev"),       range(0, 1.00, 0.5, 0.5),    colour("orange"), trackercolour("yellow"), fontcolour("white"), ;fontcolour("black")
</Cabbage>
<CsoundSynthesizer>
<CsOptions>
-d -n
