...
<<<<<<< HEAD
set PREPROCESSOR_DEFS=-D__MINGW__=1 -DWIN32 -D__MINGW_EXTENSION=1 -DBUILD_DEBUGGER=1 -DCabbage_Build_Standalone=1 -DUSE_DOUBLE=1 -DCSOUND6=1 -DJUCE_MINGW=1 -DCabbage_GUI_Editor=1 -DJUCER_CODEBLOCKS_20734A5D=1
=======
set PREPROCESSOR_DEFS=-D__MINGW__=1 -DWIN32 -D__MINGW_EXTENSION=1 -DBUILD_DEBUGGER=1 -DCabbage_Build_Standalone=1 -DUSE_DOUBLE=1 -DCSOUND6=1 -DCabbage_GUI_Editor=1 -DJUCER_CODEBLOCKS_20734A5D=1 -DCabbage64Bit=1
...
<<<<<<< HEAD
set COMPILER_FLAGS= -Wall -Wreorder -Wno-strict-aliasing -ggdb -march=x86-64 -Wno-strict-overflow -static-libgcc -static-libstdc++ -g -O0 -std=gnu++0x -mstackrealign
=======
