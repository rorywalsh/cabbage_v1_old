<Cabbage>
form caption("Autopan / Tremolo") size(380, 130)
image pos(10, 10), size(360, 90), colour("Maroon"), shape("rounded"), outline("white"), line(4) 
rslider bounds(15, 16, 70, 70), text("Rate"), channel("rate"), range(0.1, 50, 0.5, 0.5)
rslider bounds(75, 16, 70, 70), text("Depth"), channel("depth"), range(0, 1, 1, 0.5)
combobox bounds(155, 25, 120,25), channel("mode"), size(100,50), value(1), text("Autopan", "Tremolo")
combobox bounds(155, 55, 120,25), channel("wave"), size(100,50), value(1), text("Sine", "Triangle", "Square")
rslider bounds(285, 16, 70, 70), text("Level"), channel("level"), range(0, 1, 1)
