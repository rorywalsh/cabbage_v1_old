...
ifeq ($(CONFIG),Debug)
  ...
  CPPFLAGS := $(DEPFLAGS) -I $(JUCE_LIBRARY_CODE) -I $(VST_SDK) -I $(ASIO_SDK) -I $(CSOUND_INCLUDE) -DCabbage64Bit=1 -D "Cabbage_Plugin_Synth=1" -D__MINGW32__=1 -D__MINGW_EXTENSION=1 -DJUCE_MINGW=1 -DUSE_DOUBLES=1 -DCSOUND6 -DWIN32 -DUSE_DOUBLE=1 -DJUCER_CODEBLOCKS_20734A5D=1
...
ifeq ($(CONFIG),Release)
  ...
  CPPFLAGS := $(DEPFLAGS) -I $(JUCE_LIBRARY_CODE) -I $(VST_SDK) -I $(ASIO_SDK) -I $(CSOUND_INCLUDE) -DCabbage64Bit=1 -D "Cabbage_Plugin_Synth=1" -D__MINGW32__=1 -D__MINGW_EXTENSION=1 -DJUCE_MINGW=1 -DUSE_DOUBLES=1 -DCSOUND6 -DUSE_DOUBLE=1 -DJUCER_CODEBLOCKS_20734A5D=1
