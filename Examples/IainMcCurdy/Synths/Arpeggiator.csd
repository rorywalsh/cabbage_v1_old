...
rslider  bounds(440, 30, 60, 60), text("Swing"), channel("swing"), range(0, 1, 0)
...
rslider  bounds(110,150, 60, 60), text("Sus."), channel("Asus"), range(0,     1, 1)
...
rslider  bounds(390,150, 60, 60), text("Sus."), channel("sus"), 		range(0,     1, 0.5)
rslider  bounds(440,150, 60, 60), text("Rel."), channel("rel"),		range(0.001, 2, 0.1, 0.5)
rslider  bounds(490,150, 60, 60), text("Res."), channel("res"),		range(0,     1, 0.5)
rslider  bounds(540,150, 60, 60), text("Dist."), channel("dist"), 		range(0,     1, 0)
...
rslider  bounds(300,250, 60, 60), text("Port."), channel("NotePort"), 	range(0, 1,   0, 0.5)
rslider  bounds(350,250, 60, 60), text("Level"), channel("SynLev"),	range(0, 1,   0.3)
...
rslider  bounds(530,250, 60, 60), text("Mix"), channel("DryWet"),	range(0,  1,   0.1)
rslider  bounds(580,250, 60, 60), text("Time"), channel("DlyTim"),	range(1, 16,   4,1,1)
rslider  bounds(630,250, 60, 60), text("F.back"), channel("DlyFB"),	range(0,  1,   0.5)
}
