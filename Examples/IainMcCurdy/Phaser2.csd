<Cabbage>
form caption("phaser2") size(570, 120)
image pos(0, 0), size(570, 90), colour("Blue"), shape("rounded"), outline("white"), line(4) 
...
combobox bounds(210, 20, 80,25), channel("mode"), size(100,50), value(1), text("Equal", "Power")
