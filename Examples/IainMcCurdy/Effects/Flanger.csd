<Cabbage>
form caption("Flanger") size(510, 120)
image pos(0, 0), size(510, 90), colour("lightgreen"), shape("rounded"), outline("white"), line(4) 
rslider bounds(  5, 10, 70, 70), text("Rate"), channel("rate"), range(0.001, 40, 0.15, 0.5, 0.001), colour("DarkGreen"), tracker("DarkGreen"), fontcolour("DarkGreen")
rslider bounds( 75, 10, 70, 70), text("Depth"), channel("depth"), range(0, 0.01, 0.005,1,0.0001), colour("DarkGreen"), tracker("DarkGreen"), fontcolour("DarkGreen")
rslider bounds(145, 10, 70, 70), text("Delay"), channel("delay"), range(0.0001, 0.1, 0.0001, 0.5, 0.0001), colour("DarkGreen"), tracker("DarkGreen"), fontcolour("DarkGreen"))
rslider bounds(215, 10, 70, 70), text("Feedback"), channel("fback"), range(-1, 1, 0), colour("DarkGreen"), tracker("DarkGreen"), fontcolour("DarkGreen")
rslider bounds(285, 10, 70, 70), text("Mix"), channel("mix"), range(0, 1, 0.5), colour("DarkGreen"), tracker("DarkGreen"), fontcolour("DarkGreen")
checkbox bounds(355, 10, 80, 20), colour("yellow"), channel("ThruZero"),  value(1), text("Thru.Zero"), fontcolour("DarkGreen"), shape("rounded")
label    bounds(365, 37, 70, 12), text("LFO Shape"), fontcolour("DarkGreen")
combobox bounds(355, 50, 80, 20), channel("lfoshape"), size(100,50), value(1), text("parabola", "sine", "triangle", "randomi", "randomh")
rslider bounds(435, 10, 70, 70), text("Level"), channel("level"), range(0, 1, 1), colour("DarkGreen"), tracker("DarkGreen"), fontcolour("DarkGreen")
</Cabbage>
