<Cabbage>
form caption("Ring Modulation Synthesiser") size(605,330), pluginID("RMSy")
...
image      bounds(4, 168, 130, 160), colour(0,0,0,0), outlinecolour("white"), outlinethickness(4), shape("rounded"), plant("Detune") {
...
image      bounds(140, 168, 130, 160), colour(0,0,0,0), outlinecolour("white"), outlinethickness(4), shape("rounded"), plant("Output") {
...
keyboard   bounds(274, 170, 324, 118)

label bounds(274, 300, 179, 17), text("Iain McCurdy |2015|"), align("left"),  colour(0, 0, 0, 0), 
</Cabbage>
; RingModSynth.csd
; Iain McCurdy, 2015
...
; OSC.1
; -----
; Decay		--	decay time in seconds. Actually this affects the decay times for osc.2 and the modulator oscillator as they will be defined as ratios of this value.
