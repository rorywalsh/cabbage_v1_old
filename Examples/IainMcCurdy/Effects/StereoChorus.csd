<Cabbage>
form caption("Stereo Chorus") size(305, 130)
...
rslider bounds( 80, 13, 75, 75), text("Depth"), channel("depth"), range(0, 1, 0.2), fontcolour("white"), colour("tan")
rslider bounds(150, 13, 75, 75), text("Width"), channel("width"), range(0, 1, 0.75), fontcolour("white"), colour("tan")
rslider bounds(220, 13, 75, 75), text("Level"), channel("level"), range(0, 1, 1), fontcolour("white"), colour("tan")
</Cabbage>
<CsoundSynthesizer>
<CsOptions>
-d -n
