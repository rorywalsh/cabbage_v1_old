...
image                  bounds(0, 0,540,240), colour(150,150,205), shape("rounded"), outlinecolour("white"), line(4) 

rslider  bounds(  5, 11, 70, 70),  text("Threshold"), fontcolour("black"),  channel("threshold"), range(0, 1.00, 0.1, 0.5),      colour( 40, 40, 95),trackercolour(100,100,150)
                     
line     bounds( 83, 10, 95, 3), colour("Grey")
label    bounds(100,  6, 60, 10), text("DELAY TIME"), fontcolour("black"), colour(150,150,205)

rslider bounds( 72, 18, 63, 63),  text("Min."),	    fontcolour("black"),  channel("dly1"), 	range(0.0001, 2, 0.001,0.5), colour( 40, 40, 95),trackercolour(100,100,150)
rslider bounds(130, 18, 63, 63), text("Max."), 	    fontcolour("black"),  channel("dly2"), 	range(0.0001, 2, 0.1, 0.5),  colour( 40, 40, 95),trackercolour(100,100,150)

line     bounds(202, 10,  95,  3), colour("Grey")
label    bounds(222,  6,  55, 10), text("FEEDBACK"), fontcolour("black"), colour(150,150,205)

rslider bounds(190, 18, 63, 63), text("Min."),      fontcolour("black"),  channel("fback1"), 	range(0, 1.200, 0.5),        colour( 40, 40, 95),trackercolour(100,100,150)
rslider bounds(248, 18, 63, 63), text("Max."),      fontcolour("black"),  channel("fback2"), 	range(0, 1.200, 0.9),        colour( 40, 40, 95),trackercolour(100,100,150)

rslider bounds(  5, 81, 70, 70), text("Portamento"),fontcolour("black"),  channel("porttime"), 	range(0,  5.00, 0,0.5),         colour( 40, 40, 95),trackercolour(100,100,150)
rslider bounds( 65, 81, 70, 70), text("Cutoff"),   fontcolour("black"),  channel("cf"), 	range(50,10000, 5000,0.5), colour( 40, 40, 95),trackercolour(100,100,150)
rslider bounds(125, 81, 70, 70), text("Bandwidth"),   fontcolour("black"),  channel("bw"), 	range(600,22050, 4000,0.5), colour( 40, 40, 95),trackercolour(100,100,150)

rslider bounds(  5,151, 70, 70), text("Width"),	    fontcolour("black"),  channel("width"), 	range(0,  1.00, 1),         colour( 40, 40, 95),trackercolour(100,100,150)
rslider bounds( 65,151, 70, 70), text("Mix"), 	    fontcolour("black"),  channel("mix"), 	range(0, 1.00, 0.5),        colour( 40, 40, 95),trackercolour(100,100,150)
rslider bounds(125,151, 70, 70), text("Level"),	    fontcolour("black"),  channel("level"), 	range(0, 1.00, 1),          colour( 40, 40, 95),trackercolour(100,100,150)
