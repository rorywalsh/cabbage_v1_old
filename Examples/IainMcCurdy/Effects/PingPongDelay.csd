<Cabbage>
form caption("Ping Pong Delay") size(350, 120)
image pos(0, 0), size(350, 90), colour("Maroon"), shape("rounded"), outline("white"), line(4) 
rslider bounds(10, 11, 70, 70), text("Time"), channel("time"), range(0.001, 10, 0.4, 0.5), colour("255,100,100")
rslider bounds(75, 11, 70, 70), text("Cutoff"), channel("cutoff"), range(20,20000,20000,0.5), colour("255,100,100")
rslider bounds(140, 11, 70, 70), text("Feedback"), channel("feedback"), range(0, 1, 0.5), colour("255,100,100")
rslider bounds(205, 11, 70, 70), text("Mix"), channel("mix"), range(0, 1, 0.5), colour("255,100,100")
rslider bounds(270, 11, 70, 70), text("Level"), channel("level"), range(0, 1, 0.7), colour("255,100,100")
