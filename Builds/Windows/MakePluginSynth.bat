...
set PreProcessorDefs=-D__MINGW__=1 -DJUCE_MINGW -D__MINGW_EXTENSION= -DCSOUND6 -D Cabbage_Plugin_Synth=1 -DUSE_DOUBLE=1 -DJUCER_CODEBLOCKS_20734A5D=1
...
g++.exe -Wall -Wno-strict-aliasing -Wno-strict-overflow  -march=pentium4 -g -O0 -std=gnu++0x -mstackrealign %PreProcessorDefs%    -I. -I..\..\JuceLibraryCode -I%CsoundIncludeDir% -I%ASIOSDK2Dir% -I%VSTSDKDir%  -c %CabbageSourceDir%\Plugin\CabbagePluginEditor.cpp -o build\intermediate\Debug\CabbagePluginEditor.o
