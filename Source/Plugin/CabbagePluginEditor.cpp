...
{
	getFilter()->messageQueue.addOutgoingChannelMessageToQueue(CabbageIDs::mousex, event.getPosition().getX(), "");
	getFilter()->messageQueue.addOutgoingChannelMessageToQueue(CabbageIDs::mousey, event.getPosition().getY(), "");
}
